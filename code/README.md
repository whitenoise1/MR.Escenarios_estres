# code/ — versión modular de MR_EscenariosEstres.R
...
Ejecutar `main.R` con el directorio de trabajo en la **raíz del repositorio** (no dentro de `code/`), para que las lecturas relativas de `Regimenes de TPM.xlsx` y de los CSV precomputados funcionen sin cambios:
